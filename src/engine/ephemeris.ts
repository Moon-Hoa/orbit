...
export const PLANET_IDS: PlanetId[] = ['mercury', 'venus', 'earth', 'mars']
...
type RatedValue = readonly [atJ2000: number, perCentury: number]

interface PlanetaryElementRates {
  /** Semi-major axis, AU. */
 ...
 * century past J2000.0) for the four terrestrial planets, valid ~1800-2050 AD
 * to within a few arcminutes - Standish, JPL Solar System Dynamics,
 * "Keplerian Elements for Approximate Positions of the Major Planets"
 * (https://ssd.jpl.nasa.gov/planets/approx_pos.html). This deliberately
 * ignores planetary perturbations (Jupiter's pull on Mars, etc.) - the same
 * "two-body only" simplification the rest of this app's orbit engine makes
 * (see Phase 1) - appropriate for a "basic" solar system view, not
 * mission-planning precision. See the Moon/Mars view issues for the same
...
export function planetHeliocentricPositionAu(planet: PlanetId, date: Date): Vector3 {
  const rates = PLANETARY_ELEMENTS[planet]
